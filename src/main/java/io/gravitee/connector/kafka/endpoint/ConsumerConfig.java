...
public class ConsumerConfig {
  ...
  public Map<String, String> getKafkaConfig() {
    ...
    config.put(
      ...
      Integer.toString(getSessionTimeoutMs())
    );
    config.put(
    ...
    config.put(
      org.apache.kafka.clients.consumer.ConsumerConfig.CLIENT_RACK_CONFIG,
      getClientRack()
    );
    config.put(
    ...
    config.put(
      org.apache.kafka.clients.consumer.ConsumerConfig.SEND_BUFFER_CONFIG,
      Integer.toString(getSendBufferBytes())
    );
    config.put(
      org.apache.kafka.clients.consumer.ConsumerConfig.RECEIVE_BUFFER_CONFIG,
      Integer.toString(getReceiveBufferBytes())
    );
    config.put(
      org.apache.kafka.clients.consumer.ConsumerConfig.FETCH_MIN_BYTES_CONFIG,
      Integer.toString(getFetchMinBytes())
    );
    config.put(
      org.apache.kafka.clients.consumer.ConsumerConfig.FETCH_MAX_BYTES_CONFIG,
      Integer.toString(getFetchMaxBytes())
    );
    config.put(
      org.apache.kafka.clients.consumer.ConsumerConfig.FETCH_MAX_WAIT_MS_CONFIG,
      Integer.toString(getFetchMaxWaitMs())
    );
    config.put(
      org.apache.kafka.clients.consumer.ConsumerConfig.RECONNECT_BACKOFF_MS_CONFIG,
    ...
    config.put(
      org.apache.kafka.clients.consumer.ConsumerConfig.CHECK_CRCS_CONFIG,
      Boolean.toString(isCheckCRCS())
    );
    config.put(
    ...
    config.put(
      org.apache.kafka.clients.consumer.ConsumerConfig.METRICS_NUM_SAMPLES_CONFIG,
      Integer.toString(getMetricsNumSamples())
    );
    config.put(
      org.apache.kafka.clients.consumer.ConsumerConfig.METRICS_RECORDING_LEVEL_CONFIG,
      getMetricsRecordingLevel()
    );
    config.put(
      org.apache.kafka.clients.consumer.ConsumerConfig.METRIC_REPORTER_CLASSES_CONFIG,
    ...
    config.put(
      org.apache.kafka.clients.consumer.ConsumerConfig.SECURITY_PROVIDERS_CONFIG,
